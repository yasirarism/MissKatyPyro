...
async def help(client, message):
    if message.chat.type in ["group", "supergroup"]:
        ...
        return await message.reply("Silahkan PM saya untuk melihat menu bantuan..", reply_markup=InlineKeyboardMarkup(buttons))
    else:
        buttons = [
            [InlineKeyboardButton("Admin", callback_data="manuelfilter"), InlineKeyboardButton("Code Runner", callback_data="autofilter")],
            [InlineKeyboardButton("Connection", callback_data="coct"), InlineKeyboardButton("Misc", callback_data="extra")],
        ...
        await message.reply_text(text=script.HELP_TXT.format(message.from_user.mention, currentTime, total, free, used, cpuUsage, memory, disk), reply_markup=reply_markup, parse_mode=enums.ParseMode.HTML)
...
async def start(client, message):
    if message.chat.type == "private" and message.text == "/start help":
        buttons = [
            [InlineKeyboardButton("Admin", callback_data="manuelfilter"), InlineKeyboardButton("Code Runner", callback_data="autofilter")],
            [InlineKeyboardButton("Stickers", callback_data="coct"), InlineKeyboardButton("Misc", callback_data="extra")],
            [InlineKeyboardButton("🏠 Home", callback_data="start"), InlineKeyboardButton("🔮 Status", callback_data="stats")],
        ]
        currentTime = get_readable_time(time.time() - botStartTime)
        total, used, free = shutil.disk_usage(".")
    ...
    if message.text == "/start":
        buttons = [
            ...
            [InlineKeyboardButton("YMovieZNew Channel", url="https://t.me/YMovieZNew"), InlineKeyboardButton("Updates", url="https://t.me/YasirPediaChannel")],
