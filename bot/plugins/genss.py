        ...
        if the_real_download_location is not None:
            ...
            try:
                await client.send_media_group(chat_id=message.chat.id,
                                              ...
                                              media=images)
                await client.edit_message_text(text=f"☑️ Uploaded [{sscount}] screenshoot.\n\nGenerated by @MissKatyRoBot.", chat_id=message.chat.id,
                                         message_id=process.id)
            except FloodWait as e:
                await sleep(e.value)
                await client.send_media_group(chat_id=message.chat.id,
        ...
        try:
            ...
            try:
                await client.send_media_group(chat_id=message.chat.id,
                                              ...
                                              reply_to_message_id=message.id,
                                              media=images)
                await client.edit_message_text(text=f"☑️ Uploaded [8] screenshoot.\n\nGenerated by @MissKatyRoBot.", message_id=process.id,
                                          message_id=process.id)
            except FloodWait as e:
                await sleep(e.value)
                await client.send_media_group(chat_id=message.chat.id,
