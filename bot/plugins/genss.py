    ...
    if message.reply_to_message is not None:
        ...
        if the_real_download_location is not None:
            try:
                ...
                images = await generate_screen_shots(process, the_real_download_location, tmp_directory_for_each_user, 5, sscount)
