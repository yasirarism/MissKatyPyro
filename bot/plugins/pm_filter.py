...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(text=script.HELP_TXT.format(query.from_user.mention, currentTime, total, free, used, cpuUsage, memory, disk), reply_markup=reply_markup, parse_mode=enums.ParseMode.HTML)
    elif query.data == "about":
        buttons = [
            [InlineKeyboardButton("🤖 Updates", url="https://t.me/YasirPediaChannel"), InlineKeyboardButton("♥️ Source", callback_data="source")],
        ...
        await query.message.edit_text(text=teks, reply_markup=reply_markup, parse_mode=enums.ParseMode.HTML)
