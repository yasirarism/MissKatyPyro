    ...
    if temp.ME in r_j_check:
        if not await db.get_chat(message.chat.id):
            ...
            await bot.send_message(
                LOG_CHANNEL,
                strings("log_bot_added").format(
                    ttl=message.chat.title, cid=message.chat.id, tot=total, r_j=r_j
                ),
            )
            ...
            buttons = [
                [
                    InlineKeyboardButton(
                        strings("support_btn"), url=f"https://t.me/{SUPPORT_CHAT}"
                    )
                ]
            ]
        ...
        buttons = [
            [
                InlineKeyboardButton(
                    strings("help_btn"), url=f"https://t.me/{temp.U_NAME}?start=help"
                ),
                InlineKeyboardButton(
                    strings("update_btn"), url="https://t.me/YasirPediaChannel"
                ),
            ]
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
